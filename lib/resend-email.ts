...
const WELCOME_EMAIL_FROM = "Arthur & Adam (ParkingOath) <team@parkingoath.com.au>";
...
function buildWelcomeTextBody(firstName?: string) {
  ...
  return [
    `Hey ${greetingName},`,
    "",
    "Thanks for reaching out to ParkingOath, we mean that. We're Arthur and Adam, the two people who got sick of circling the block looking for a park, so we decided to build something about it. We'll be in touch about your enquiry really soon, but we wanted to send this one ourselves first.",
    "",
...
function buildWelcomeHtmlBody(firstName?: string) {
  ...
  return `
    <div style="font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#1e293b;">
      ...
      <p>Thanks for reaching out to ParkingOath, we mean that. We're Arthur and Adam, the two people who got sick of circling the block looking for a park, so we decided to build something about it. We'll be in touch about your enquiry really soon, but we wanted to send this one ourselves first.</p>
